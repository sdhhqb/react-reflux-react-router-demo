...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MyApp = __webpack_require__(216);
	...
	var rootRoute = {
	  ...
	  childRoutes: [{
	    path: '/',
	    component: _MyApp2.default,
	    childRoutes: [__webpack_require__(245), __webpack_require__(251)]
	  }]
	};

	(0, _reactDom.render)(_react2.default.createElement(_reactRouter.Router, { history: _reactRouter.hashHistory, routes: rootRoute }), document.getElementById('reactapp'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SideMenu = __webpack_require__(220);

	var _SideMenu2 = _interopRequireDefault(_SideMenu);

	var _MenuStore = __webpack_require__(243);

	var _MenuStore2 = _interopRequireDefault(_MenuStore);

	var _MenuAction = __webpack_require__(223);
	...
	var MyApp = _react2.default.createClass({
		...
		componentDidMount: function componentDidMount() {
			this.unsubscribe = _MenuStore2.default.listen(this._onChange);
			_MenuAction2.default.receive_menu_data(_Constants2.default.MENUDATA);
		},
		componentWillUnmount: function componentWillUnmount() {
			this.unsubscribe();
		},
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ id: 'mainSection', className: 'mainSection' },
		...
		_onChange: function _onChange(status) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MenuHierarchy = __webpack_require__(221);

	var _MenuHierarchy2 = _interopRequireDefault(_MenuHierarchy);
	...
	var SideMenu = _react2.default.createClass({
		...
		render: function render() {
			...
			for (var i = 0; i < menuData.length; i++) {
				...
				list.push(_react2.default.createElement(_MenuHierarchy2.default, {
					key: key,
					keyFlag: i,
					selfPath: key,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MenuHierarchy = _react2.default.createClass({
		displayName: 'MenuHierarchy',

		// 改变当前菜单展开路径
		chgCurPath: function chgCurPath(curPath) {
			_MenuAction2.default.set_menu_path(curPath);
		},
		// 计算各级菜单展开收起状态
		...
		render: function render() {
			...
			if (item.child) {
				for (i = 0; i < child.length; i++) {
					...
					list.push(_react2.default.createElement(MenuHierarchy, {
						key: key,
						keyFlag: i,
						selfPath: key,
						curPath: this.props.curPath,
				...
				return _react2.default.createElement(
					'li',
					{ className: className + " hierarchyItem level-" + item.level },
					_react2.default.createElement(
						'div',
						{ className: 'subMenu', onClick: this.toggle },
						item.name
					),
					_react2.default.createElement(
						'ul',
						{ className: className + " hierarchy" + " level-" + item.level },
						list
					)
				);
			} else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MenuItem = _react2.default.createClass({
		...
		chgKey: function chgKey() {
			if (this.props.curPath != this.props.selfPath) {
				_MenuAction2.default.set_menu_item(this.props.selfPath, this.props.item.route);
			}
		},
		render: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reflux = __webpack_require__(224);

	var _reflux2 = _interopRequireDefault(_reflux);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var Actions = _reflux2.default.createActions(['receive_menu_data', 'set_initial_active', 'set_menu_path', 'set_menu_item']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(225);

	Reflux.connect = __webpack_require__(238);

	Reflux.connectFilter = __webpack_require__(240);

	Reflux.ListenerMixin = __webpack_require__(239);

	Reflux.listenTo = __webpack_require__(241);

	Reflux.listenToMany = __webpack_require__(242);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.ActionMethods = __webpack_require__(226);

	Reflux.ListenerMethods = __webpack_require__(227);

	Reflux.PublisherMethods = __webpack_require__(236);

	Reflux.StoreMethods = __webpack_require__(235);

	Reflux.createAction = __webpack_require__(237);

	Reflux.createStore = __webpack_require__(231);

	var maker = __webpack_require__(230).staticJoinCreator;
	...
	var _ = Reflux.utils = __webpack_require__(228);
	...
	Reflux.__keep = __webpack_require__(232);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(228),
	    maker = __webpack_require__(230).instanceJoinCreator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EventEmitter = __webpack_require__(229);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createStore = __webpack_require__(231),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (definition) {
	    ...
	    var StoreMethods = __webpack_require__(235),
	        PublisherMethods = __webpack_require__(236),
	        ListenerMethods = __webpack_require__(227);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(228),
	    ActionMethods = __webpack_require__(226),
	    PublisherMethods = __webpack_require__(236),
	    Keep = __webpack_require__(232);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListenerMethods = __webpack_require__(227),
	    ListenerMixin = __webpack_require__(239),
	    _ = __webpack_require__(228);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Store = _reflux2.default.createStore({
		listenables: _MenuAction2.default,
		onReceive_menu_data: function onReceive_menu_data(menuData) {
			setMenuData(menuData);
			this.output();
		},
		onSet_menu_path: function onSet_menu_path(curPath) {
			setCurPath(curPath);
			this.output();
		},
		onSet_menu_item: function onSet_menu_item(curPath, curActive) {
			setCurPath(curPath);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Product = __webpack_require__(246);
	...
	var productRoute = {
		...
		getChildRoutes: function getChildRoutes(location, callback) {
			__webpack_require__.e/* nsure */(1, function (require) {
				callback(null, [__webpack_require__(247), __webpack_require__(249)]);
			});
		}
	};
